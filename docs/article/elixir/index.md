...
1. [01: TODO リストと最初のテスト](./01-todo-list-and-first-test.md)
2. [02: 仮実装と三角測量](./02-fake-it-and-triangulation.md)
3. [03: 明白な実装とリファクタリング](./03-obvious-implementation-and-refactoring.md)

### 第 2 部: 開発環境と自動化

1. [04: バージョン管理と Conventional Commits](./04-version-control-and-conventional-commits.md)
2. [05: パッケージ管理と静的解析](./05-package-management-and-static-analysis.md)
3. [06: タスクランナーと CI/CD](./06-task-runner-and-ci-cd.md)
