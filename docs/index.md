...
- [テスト駆動開発から始めるプログラミング入門](./article/index.md) - 12 言語で TDD を体験する記事シリーズ
- [執筆計画アウトライン](./article/outline.md) - 記事の全体構成と執筆計画
- [執筆ワークフロー](./article/workflow.md) - 執筆・実装の進め方

## 開発

- [リリース計画](./development/release_plan.md) - 3 フェーズ × 12 イテレーションのリリース計画
- [イテレーション 1 計画](./development/iteration_plan-1.md) - Java（基準言語）の執筆・実装計画
...
- [ふりかえり 6](./development/retrospective-6.md) - IT6 の KPT 分析
- [完了報告書 6](./development/iteration_report-6.md) - IT6 の実績と評価
...
- [デバッガセットアップ手順](./reference/debugger.md) - Ruby + Vimspector + rdbg の設定と切り分け

## その他

- [アーキテクチャ決定ログ](./adr) - アーキテクチャに関する重要な決定の記録
