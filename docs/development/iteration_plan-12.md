...
- [ ] docs/article/haskell/index.md と 12 章の記事ファイルが作成済み
- [ ] apps/haskell/ のテストがすべてパス
- [ ] mkdocs.yml に Haskell セクションが追加され、プレビュー確認済み
- [ ] HLint 警告ゼロ
- [ ] 記事内コード例と apps/haskell/ の実コードが同期
- [ ] docs/article/integration/ に統合解説が作成済み
- [ ] mkdocs.yml に統合解説セクションが追加済み
- [ ] GitHub Issue #12, #13 がクローズ済み
- [ ] Release 3.0 リリース条件を達成
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 0.1 | apps/haskell/ に Stack プロジェクトを作成 | 0.5h | AI | [ ] |
| 0.2 | .gitignore 先行設定（.stack-work/、dist-newstyle/ 除外） | 0.5h | AI | [ ] |
| 0.3 | テスト構成の確認（stack test / HSpec） | 0.5h | AI | [ ] |
| 0.4 | Makefile 作成（check タスク統合） | 0.5h | AI | [ ] |
| 0.5 | CI ワークフロー（.github/workflows/haskell-ci.yml）を Nix ベースで作成 | 0.5h | AI | [ ] |
| 0.6 | docs/article/haskell/index.md を作成 | 0.5h | AI | [ ] |
...
| 2.2 | 章 5: パッケージ管理と静的解析（Stack、HLint、Fourmolu）- 執筆 | 2h | AI | [ ] |
| 2.3 | 章 6: タスクランナーと CI/CD（Makefile、Nix、GitHub Actions）- 執筆 | 2h | AI | [ ] |
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 3.1 | 章 7: 代数的データ型と型クラスによるポリモーフィズム - 執筆・実装 | 3h | AI | [ ] |
| 3.2 | 章 8: パターンマッチとガード - 執筆・実装 | 3h | AI | [ ] |
| 3.3 | 章 9: モジュール設計とスマートコンストラクタ - 執筆・実装 | 3h | AI | [ ] |
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 4.1 | 章 10: 高階関数とカリー化（map、filter、fold、部分適用）- 執筆・実装 | 2h | AI | [ ] |
| 4.2 | 章 11: 関数合成とポイントフリースタイル（(.)、($)、flip）- 執筆・実装 | 2h | AI | [ ] |
| 4.3 | 章 12: モナドとエラーハンドリング（Maybe、Either、do 記法）- 執筆・実装 | 2h | AI | [ ] |
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 5.1 | 統合解説: 12 言語の概要と分類（OOP/FP/マルチパラダイム）- 執筆 | 3h | AI | [ ] |
| 5.2 | 統合解説: テストフレームワーク・ツールチェーン比較表 - 執筆 | 2h | AI | [ ] |
| 5.3 | 統合解説: パラダイム別 TDD パターン比較 - 執筆 | 3h | AI | [ ] |
| 5.4 | 統合解説: 型システム・エラーハンドリング比較 - 執筆 | 2h | AI | [ ] |
| 5.5 | 統合解説: 開発環境と CI/CD 比較（Nix 統一アプローチ）- 執筆 | 2h | AI | [ ] |
| 5.6 | 統合解説: 学習ロードマップと推奨順序 - 執筆 | 2h | AI | [ ] |
| 5.7 | mkdocs.yml 更新とプレビュー確認 | 0.5h | AI | [ ] |
| 5.8 | docs/index.md 更新 | 0.5h | AI | [ ] |
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 6.1 | GitHub Issue #12, #13 のクローズ | 0.5h | AI | [ ] |
| 6.2 | GitHub Project ステータス更新（Done） | 0.5h | AI | [ ] |
| 6.3 | docs/development/release_plan.md の最終更新 | 0.5h | AI | [ ] |
| 6.4 | docs/development/index.md 更新 | 0.5h | AI | [ ] |
...
- [ ] 12 章の記事ファイルが docs/article/haskell/ に存在
- [ ] apps/haskell/ の全テストがパス
- [ ] HLint 警告ゼロ
- [ ] mkdocs.yml に Haskell セクションが追加済み
- [ ] ローカルプレビューで表示確認済み
- [ ] 記事内コード例と apps/haskell/ の実コードが同期
- [ ] docs/article/integration/ に統合解説が作成済み
- [ ] mkdocs.yml に統合解説セクションが追加済み
