...
- [ ] docs/article/rust/index.md と 12 章の記事ファイルが作成済み
- [ ] apps/rust/ の cargo test がすべてパス
- [ ] mkdocs.yml に Rust セクションが追加され、プレビュー確認済み
- [ ] Clippy 警告ゼロ
- [ ] rustfmt 違反ゼロ
- [ ] 記事内コード例と apps/rust/ の実コードが同期
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 0.1 | apps/rust/ に Cargo プロジェクトを初期化（cargo new） | 0.5h | AI | [ ] |
| 0.2 | テスト構成の確認（cargo test） | 0.5h | AI | [ ] |
| 0.3 | Clippy / rustfmt 設定の確認 | 0.5h | AI | [ ] |
| 0.4 | CI ワークフロー（.github/workflows/rust-ci.yml）の作成 | 0.5h | AI | [ ] |
| 0.5 | docs/article/rust/index.md を作成 | 0.5h | AI | [ ] |
...
| 2.4 | 章 5: Cargo / Clippy / rustfmt の導入と設定 - 実装 | 1h | Codex | [ ] |
...
| 3.2 | 章 7: struct + impl / trait によるポリモーフィズム - 実装 | 2h | Codex | [ ] |
...
| 3.6 | 章 9: モジュール分割（domain/types, domain/model, application） - 実装 | 2h | Codex | [ ] |
...
| 4.2 | 章 10: クロージャ / イテレータ / map・filter - 実装 | 1h | Codex | [ ] |
| 4.3 | 章 11: 不変データとパイプライン処理 - 執筆 | 2h | AI | [ ] |
| 4.4 | 章 11: イテレータチェーン / collect / fold - 実装 | 1h | Codex | [ ] |
| 4.5 | 章 12: エラーハンドリングと型安全性 - 執筆 | 2h | AI | [ ] |
| 4.6 | 章 12: Result / Option / enum パターンマッチ - 実装 | 1h | Codex | [ ] |
...
- [ ] 12 章の記事ファイルが docs/article/rust/ に存在
- [ ] apps/rust/ の全テストがパス
- [ ] Clippy 警告ゼロ
- [ ] rustfmt 違反ゼロ
- [ ] mkdocs.yml に Rust セクションが追加済み
- [ ] ローカルプレビューで表示確認済み
- [ ] 記事内コード例と apps/rust/ の実コードが同期
