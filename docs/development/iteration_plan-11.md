...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 0.1 | apps/elixir/ に Mix プロジェクトを作成 | 0.5h | AI | [ ] |
| 0.2 | .gitignore 先行設定（_build/, deps/, .elixir_ls/ 除外） | 0.5h | AI | [ ] |
| 0.3 | テスト構成の確認（mix test / ExUnit） | 0.5h | AI | [ ] |
| 0.4 | Makefile 作成（check タスク統合） | 0.5h | AI | [ ] |
| 0.5 | CI ワークフロー（.github/workflows/elixir-ci.yml）を Nix ベースで作成 | 0.5h | AI | [ ] |
| 0.6 | docs/article/elixir/index.md を作成 | 0.5h | AI | [ ] |
...
| 2.2 | 章 5: パッケージ管理と静的解析（Mix、Credo、Dialyxir）- 執筆 | 2h | AI | [ ] |
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 3.1 | 章 7: 構造体とプロトコルによるポリモーフィズム - 執筆・実装 | 3h | AI | [ ] |
| 3.2 | 章 8: パターンマッチとガード節 - 執筆・実装 | 3h | AI | [ ] |
| 3.3 | 章 9: モジュール設計とビヘイビア - 執筆・実装 | 3h | AI | [ ] |
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 4.1 | 章 10: 高階関数とパイプライン演算子（\|>、関数合成）- 執筆・実装 | 2h | AI | [ ] |
| 4.2 | 章 11: Stream と遅延評価（Stream、Enum、再帰）- 執筆・実装 | 2h | AI | [ ] |
| 4.3 | 章 12: エラーハンドリングと with 構文（{:ok, _}/{:error, _}、with）- 執筆・実装 | 2h | AI | [ ] |
