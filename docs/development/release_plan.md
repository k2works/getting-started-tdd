...
| **目的** | TDD の実践を通じて 14 言語の特徴を学ぶ記事シリーズの執筆と実装 |
...
14 言語 × 4 部（12 章）の記事執筆と実装コードを 3 フェーズに分けてリリースする。
...
| モチベーション低下（14 言語の繰り返し） | 中 | 中 | パラダイムの異なる言語を交互に配置 |
