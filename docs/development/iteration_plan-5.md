...
- [ ] docs/article/go/index.md と 12 章の記事ファイルが作成済み
- [ ] apps/go/ の Go テストがすべてパス
- [ ] mkdocs.yml に Go セクションが追加され、プレビュー確認済み
- [ ] テストカバレッジ 80% 以上
- [ ] golangci-lint 違反ゼロ
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 0.1 | apps/go/ に Go Modules プロジェクトを初期化（go mod init） | 0.5h | AI | [ ] |
| 0.2 | testing パッケージ + testify（任意）のセットアップ | 0.5h | AI | [ ] |
| 0.3 | golangci-lint 設定ファイル（.golangci.yml）の作成 | 0.5h | AI | [ ] |
| 0.4 | Makefile（テスト・lint・カバレッジタスク）の作成 | 0.5h | AI | [ ] |
| 0.5 | docs/article/go/index.md を作成 | 0.5h | AI | [ ] |
...
| 2.4 | 章 5: Go Modules / golangci-lint の導入と設定 - 実装 | 1h | Codex | [ ] |
...
| 3.2 | 章 7: 非公開フィールド / インターフェースによるポリモーフィズム - 実装 | 2h | Codex | [ ] |
...
| 3.6 | 章 9: パッケージ分割（domain/type, domain/model, application） - 実装 | 2h | Codex | [ ] |
...
| 4.2 | 章 10: ファーストクラス関数 / クロージャ / 関数合成 - 実装 | 1h | Codex | [ ] |
| 4.3 | 章 11: 不変データとパイプライン処理 - 執筆 | 2h | AI | [ ] |
| 4.4 | 章 11: スライス操作パイプライン / 不変設計パターン - 実装 | 1h | Codex | [ ] |
| 4.5 | 章 12: エラーハンドリングと型安全性 - 執筆 | 2h | AI | [ ] |
| 4.6 | 章 12: ジェネリクス / error インターフェース / 型スイッチ - 実装 | 1h | Codex | [ ] |
