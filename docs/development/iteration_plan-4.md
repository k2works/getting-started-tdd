...
- `tmp/k2works-wiki/記事/開発/テスト駆動開発から始めるプログラミング入門/テスト駆動開発から始めるRuby入門1.md`
- `tmp/k2works-wiki/記事/開発/テスト駆動開発から始めるプログラミング入門/エピソード1_example_ruby.md`
...
- `tmp/k2works-wiki/記事/開発/テスト駆動開発から始めるプログラミング入門/テスト駆動開発から始めるRuby入門2.md`
...
| 3.2 | 章 7: attr_reader/ダックタイピングによるポリモーフィズム - 実装 | 2h | Codex | [x] |
...
| 3.6 | 章 9: モジュール分割（domain/type, domain/model, application） - 実装 | 2h | Codex | [x] |

**小計**: 15h（理想時間）

**参照**:

- `tmp/k2works-wiki/記事/開発/テスト駆動開発から始めるプログラミング入門/テスト駆動開発から始めるRuby入門3.md`
...
| 4.2 | 章 10: ブロック/Proc/Lambda/カリー化 - 実装 | 1h | Codex | [x] |
| 4.3 | 章 11: 不変データとパイプライン処理 - 執筆 | 2h | AI | [x] |
| 4.4 | 章 11: Enumerable/freeze/then パイプライン - 実装 | 1h | Codex | [x] |
| 4.5 | 章 12: エラーハンドリングと型安全性 - 執筆 | 2h | AI | [x] |
| 4.6 | 章 12: パターンマッチング/Benchmark/プロファイリング - 実装 | 1h | Codex | [x] |
...
- `tmp/k2works-wiki/記事/開発/テスト駆動開発から始めるプログラミング入門/テスト駆動開発から始めるRuby入門4.md`
...
| 第 4 部: 関数型プログラミング + ベンチマーク + 同期確認 | 3 | 10.5h | [x] |
| Release 1.0 準備 | 0 | 4h | [ ] |
| **合計** | **13** | **50.5h** | |
