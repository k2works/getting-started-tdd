...
**参照**: `tmp/k2works-wiki/記事/開発/テスト駆動開発から始めるプログラミング入門/テスト駆動開発から始めるJava入門1.md`
...
**参照**: `tmp/k2works-wiki/記事/開発/テスト駆動開発から始めるプログラミング入門/テスト駆動開発から始めるJava入門2.md`
...
**参照**: `tmp/k2works-wiki/記事/開発/テスト駆動開発から始めるプログラミング入門/テスト駆動開発から始めるJava入門3.md`

#### 4. 仕上げ（0 SP - バッファ）

| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 4.1 | 第 4 部（章 10-12）: Java の関数型機能 - 執筆 | 4h | AI | [x] |
| 4.2 | 第 4 部: Stream API/Optional/Lambda - 実装 | 2h | Codex | [x] |
| 4.3 | 記事と実装の同期確認 | 1h | AI | [x] |
| 4.4 | mkdocs.yml 更新とプレビュー確認 | 1h | AI | [x] |
