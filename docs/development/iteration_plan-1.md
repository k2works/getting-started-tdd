...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 0.1 | apps/java/ に Gradle プロジェクトを初期化 | 1h | - | [ ] |
| 0.2 | JUnit 5 + テスト環境のセットアップ | 1h | - | [ ] |
| 0.3 | docs/article/java/index.md を作成 | 0.5h | - | [ ] |
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 1.1 | 章 1: TODO リストと最初のテスト - 執筆 | 2h | - | [ ] |
| 1.2 | 章 1: TODO リストと最初のテスト - 実装 | 1h | - | [ ] |
| 1.3 | 章 2: 仮実装と三角測量 - 執筆 | 2h | - | [ ] |
| 1.4 | 章 2: 仮実装と三角測量 - 実装 | 1h | - | [ ] |
| 1.5 | 章 3: 明白な実装とリファクタリング - 執筆 | 2h | - | [ ] |
| 1.6 | 章 3: 明白な実装とリファクタリング - 実装 | 1h | - | [ ] |
...
| # | タスク | 見積もり | 担当 | 状態 |
|---|--------|---------|------|------|
| 2.1 | 章 4: バージョン管理と Conventional Commits - 執筆 | 2h | - | [ ] |
| 2.2 | 章 4: Git 設定と Conventional Commits の適用 - 実装 | 1h | - | [ ] |
| 2.3 | 章 5: パッケージ管理と静的解析 - 執筆 | 2h | - | [ ] |
| 2.4 | 章 5: Checkstyle/SpotBugs 等の導入 - 実装 | 1h | - | [ ] |
| 2.5 | 章 6: タスクランナーと CI/CD - 執筆 | 2h | - | [ ] |
| 2.6 | 章 6: Gradle タスクと CI 設定 - 実装 | 1h | - | [ ] |
