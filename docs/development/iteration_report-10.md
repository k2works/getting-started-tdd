...
xychart-beta
    title "IT10 バーンダウン"
    x-axis ["開始", "環境構築", "第1部", "第2部", "第3部", "第4部", "追加改善"]
    y-axis "残 SP" 0 --> 13
    line "計画" [13, 12, 9, 6, 3, 0, 0]
    line "実績" [13, 12, 9, 6, 3, 0, 0]
```
...
xychart-beta
    ...
    y-axis "SP" 0 --> 15
    bar "実績" [10, 10, 13, 13, 10, 10, 10, 13, 13, 13]
    line "平均" [10, 10, 11, 11.5, 11.2, 11.0, 10.9, 11.1, 11.3, 11.5]
```
